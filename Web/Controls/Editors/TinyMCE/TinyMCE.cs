...
namespace mojoPortal.Web.Editor
{
    ...
    /// http://www.kelvinluck.com/2009/01/using-spell-checker-for-tinymce-with-net-on-iis/
    /// </summary>
    ...
    public class TinyMCE : Control, IPostBackDataHandler
    {
        ...
        private string spellCheckerUrl = string.Empty;
        public string SpellCheckerUrl
        {
            get { return spellCheckerUrl; }
            set { spellCheckerUrl = value; }
        }
        ...
        {
            get { return (ViewState["SpellCheckerLanguages"] != null ? (string)ViewState["SpellCheckerLanguages"] : ""); }
            set { ViewState["SpellCheckerLanguages"] = value; }
        }
