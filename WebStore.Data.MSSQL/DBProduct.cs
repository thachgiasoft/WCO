...
namespace WebStore.Data
{
    ...
    public static class DBProduct
    {
        ...
        public static int Add(
            ...
            string compiledMeta)
        {
            SqlParameterHelper sph = new SqlParameterHelper(WebStoreConnectionString.GetWriteConnectionString(), "ws_Product_Insert", 27);
        ...
        public static bool Update(
            ...
            string compiledMeta)
        {
            SqlParameterHelper sph = new SqlParameterHelper(WebStoreConnectionString.GetWriteConnectionString(), "ws_Product_Update", 24);
			sph.DefineSqlParameter("@Guid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, guid);
			sph.DefineSqlParameter("@TaxClassGuid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, taxClassGuid);
			sph.DefineSqlParameter("@ModelNumber", SqlDbType.NVarChar, 255, ParameterDirection.Input, modelNumber);
			sph.DefineSqlParameter("@Status", SqlDbType.TinyInt, ParameterDirection.Input, status);
        ...
        public static int AddHistory(
            ...
            DateTime logTime)
        {
            SqlParameterHelper sph = new SqlParameterHelper(WebStoreConnectionString.GetWriteConnectionString(), "ws_ProductHistory_Insert", 16);
            sph.DefineSqlParameter("@Guid", SqlDbType.UniqueIdentifier, ParameterDirection.Input, guid);
